package com.ashiquali.vonage_voice
...
import com.ashiquali.vonage_voice.ui.AnimatedCallAvatarView
...
class IncomingCallActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun createIntent(context: Context, callId: String, callerName: String): Intent {
            return Intent(context, IncomingCallActivity::class.java).apply {
                ...
                action = "com.ashiquali.vonage_voice.INCOMING_CALL"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.i(TAG, "onCreate: START pid=${Process.myPid()}")
    ...
    private fun onCreateInternal(savedInstanceState: Bundle?) {
        ...
        if (callId.isEmpty()) {
            try {
                val prefs = getSharedPreferences(TVConnectionService.Companion.PREFS_PENDING_CALL, MODE_PRIVATE)
                val storedCallId = prefs.getString(TVConnectionService.Companion.KEY_PENDING_CALL_ID, null)
                val storedFrom = prefs.getString(com.ashiquali.vonage_voice.service.TVConnectionService.Companion.KEY_PENDING_CALL_FROM, null)
                val storedTs = prefs.getLong(com.ashiquali.vonage_voice.service.TVConnectionService.Companion.KEY_PENDING_CALL_TIMESTAMP, 0)
        ...
        val filter = IntentFilter().apply {
            addAction(com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_INVITE_CANCELLED)
            addAction(com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_ENDED)
            addAction(com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_ANSWERED)
            addAction(com.ashiquali.vonage_voice.constants.Constants.BROADCAST_REAL_CALL_READY)
        }
    ...
    private fun handleAnswer() {
        ...
        val answerIntent = Intent(this, com.ashiquali.vonage_voice.service.TVConnectionService::class.java).apply {
            action = com.ashiquali.vonage_voice.constants.Constants.ACTION_ANSWER
            putExtra(com.ashiquali.vonage_voice.constants.Constants.EXTRA_CALL_ID, callId)
        }
    ...
    private fun handleDecline() {
        ...
        if (isPlaceholderMode || callId.isEmpty()) {
            ...
            val cleanupIntent = Intent(this, com.ashiquali.vonage_voice.service.TVConnectionService::class.java).apply {
                action = com.ashiquali.vonage_voice.constants.Constants.ACTION_CLEANUP
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val declineIntent = Intent(this, com.ashiquali.vonage_voice.service.TVConnectionService::class.java).apply {
                action = com.ashiquali.vonage_voice.constants.Constants.ACTION_HANGUP
                putExtra(com.ashiquali.vonage_voice.constants.Constants.EXTRA_CALL_ID, callId)
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    private fun launchMainActivity() {
        try {
            ...
            launchIntent?.let { intent ->
                ...
                intent.putExtra(com.ashiquali.vonage_voice.constants.Constants.EXTRA_CALL_ID, callId)
                intent.putExtra(com.ashiquali.vonage_voice.constants.Constants.EXTRA_CALL_FROM, callerName)
                intent.putExtra(com.ashiquali.vonage_voice.constants.Constants.EXTRA_CALL_DIRECTION, "incoming")
    ...
    private fun ensureCallPermissions(callerTag: String): Boolean {
        ...
        if (permanentlyDenied.size == missing.size && permanentlyDenied.isNotEmpty()) {
            val prefs = getSharedPreferences("vonage_permissions", MODE_PRIVATE)
