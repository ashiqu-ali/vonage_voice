 ...
 *
 * All broadcast action strings are defined in [com.ashiquali.vonage_voice.constants.Constants].
 */
class TVBroadcastReceiver(
    ...
    fun register(context: Context) {
        val filter = IntentFilter().apply {
            ...
            // ── Call state events ─────────────────────────────────────────
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_RINGING)
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_CONNECTED)
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_ENDED)
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_INVITE)
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_INVITE_CANCELLED)
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_RECONNECTING)
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_RECONNECTED)
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_FAILED)

            // ── Audio state events ────────────────────────────────────────
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_MUTE_STATE)
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_SPEAKER_STATE)
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_BLUETOOTH_STATE)
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_SYSTEM_DISCONNECT)

            // ── FCM token refresh ─────────────────────────────────────────
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_NEW_FCM_TOKEN)

            // ── Permission results ────────────────────────────────────────
            addAction(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_PERMISSION_RESULT)
        }
