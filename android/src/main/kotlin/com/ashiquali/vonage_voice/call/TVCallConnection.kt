...
class TVCallConnection(
    ...
    override fun onDisconnect() {
        ...
        destroy()
        broadcastEvent(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_SYSTEM_DISCONNECT)
    ...
    override fun onCallAudioStateChanged(state: CallAudioState) {
        ...
        if (newSpeaker != isSpeakerOn) {
            ...
            broadcastStateEvent(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_SPEAKER_STATE, isSpeakerOn)
        }
    ...
    fun setMuted(muted: Boolean) {
        ...
        broadcastStateEvent(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_MUTE_STATE, muted)
    }
    ...
    fun setBluetooth(bluetoothOn: Boolean) {
        if (bluetoothOn && isSpeakerOn) {
            ...
            isSpeakerOn = false
            broadcastStateEvent(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_SPEAKER_STATE, false)
        }
