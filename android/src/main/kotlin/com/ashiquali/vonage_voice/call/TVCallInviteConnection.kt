package com.ashiquali.vonage_voice.call
...
class TVCallInviteConnection(
    ...
    override fun onAnswer() {
        ...
        val intent = Intent(context, _root_ide_package_.com.ashiquali.vonage_voice.service.TVConnectionService::class.java).apply {
            action = _root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.ACTION_ANSWER
    ...
    override fun onAbort() {
        ...
        destroy()
        broadcastEvent(_root_ide_package_.com.ashiquali.vonage_voice.constants.Constants.BROADCAST_CALL_INVITE_CANCELLED)
    }
    ...
    override fun onShowIncomingCallUi() {
        val activityAlive = _root_ide_package_.com.ashiquali.vonage_voice.IncomingCallActivity.Companion.isActivityAlive
        ...
        if (activityAlive) {
            ...
            try {
                val updateIntent = _root_ide_package_.com.ashiquali.vonage_voice.IncomingCallActivity.Companion.createIntent(context, callId, from)
        ...
        try {
            val activityIntent = _root_ide_package_.com.ashiquali.vonage_voice.IncomingCallActivity.Companion.createIntent(context, callId, from)
